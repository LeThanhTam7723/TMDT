...
const toggleUserStatus = (id) => {
  ...
  setUsers(users.map(u =>
    u.id === id ? { ...u, active: updatedActive } : u
  ));
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setNewUser({...newUser, active: parseInt(e.target.value)})}
              className="w-full p-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600"
            >
    ...
    <div className={`${darkMode ? "dark" : ""} min-h-screen`}>
      <div className="flex bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white">
        ...
        <motion.div
          ...
          className={`${sidebarOpen ? "w-64" : "w-0"} bg-white dark:bg-gray-800 h-screen fixed transition-all duration-300 overflow-hidden z-30`}
        >
          <div className="p-4">
          ...
          <main className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold mt-2">{users.filter(u => u.active === 1).length}</h3>
                  </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Không hoạt động</p>
                    <h3 className="text-2xl font-bold mt-2">{users.filter(u => u.active === 0).length}</h3>
                  </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Người dùng mới (tháng)</p>
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 dark:bg-gray-700">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Điện thoại</th>
                      ...
                      <tr key={user.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center space-x-2">
                            ...
                            >
                              {showPassword[user.id] ? <FiEyeOff size={16} /> : <FiEye size={16} />}
                            </button>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
